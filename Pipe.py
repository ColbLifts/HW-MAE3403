...
class Pipe():
    ...
    def V(self):
        ...
        '''
        self.vel= (self.Q*0.001) / self.A #$JES MISSING CODE$  # the average velocity is Q/A (be mindful of units)
        return self.vel
    ...
    def Re(self):
        ...
        :return:
        '''
        self.reynolds= (self.fluid.rho * abs(self.V()) * self.d) / self.fluid.mu #$JES MISSING CODE$ # Re=rho*V*d/mu, be sure to use V() so velocity is updated.
