...
class ResistorNetwork():
    ...
    def AnalyzeCircuit(self):
        ...
        i0 = [0.0, 0.0, 0.0] #JES MISSING CODE  #define an initial guess for the currents in the circuit
...
class ResistorNetwork_2(ResistorNetwork):
    ...
    def AnalyzeCircuit(self):
        ...
        print("I_ad = {:0.1f}".format(i[0]))
        print("I_ad = {:0.1f}".format(i[1]))
        print("I_ad = {:0.1f}".format(i[2]))
        print("I_ad = {:0.1f}".format(i[3]))
        print("I_ad = {:0.1f}".format(i[4]))
        print("I_ad = {:0.1f}".format(i[5]))
        return i


    def GetKirchoffVals(self,i):
        self.GetResistorByName('ad').Current = i[0] #Assigning array values to resistors
        self.GetResistorByName('ad').Current = i[1]
        self.GetResistorByName('ad').Current = i[2]
        self.GetResistorByName('ad').Current = i[3]
        self.GetResistorByName('ad').Current = i[4]
        self.GetResistorByName('ad').Current = i[5]
        #Equations for KVL
        KVL1 = 16 - 2*i[1] - 1*i[2] + 2*i[0]
        KVL2 = -1*i[2] - 5*i[4] + 4*i[3]
        KVL3 = -0*i[5] + 32 +5*i[4]
        #KCL Equations because V=0
        Node_c = i[1] - i[2] -i[3]
        Node_d = i[0] + i[2] -i[4] - i[5]

        Node_ab = i[0] + i[1]

        return [KVL1,KVL2,KVL3,Node_c,Node_d,Node_ab]
